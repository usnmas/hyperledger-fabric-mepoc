#!/bin/bash
##### 4 peer / 1 org / Level DB blockchain start script 
...
##### Docker container clean up & start 
...
# Channel block fetch : Deprecated 
...
##### Instantiate the chaincode : for 2 peers rather than 1 - more that 2 causes error 
